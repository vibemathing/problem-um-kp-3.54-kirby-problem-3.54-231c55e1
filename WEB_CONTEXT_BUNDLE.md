...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-3.54-kirby-problem-3.54-231c55e1-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-3.54"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-3.54-kirby-problem-3.54-231c55e1-v1",
      "problem_contract_sha256": "c8805fe601d36adb067e767ea15b9810d1cf1b400d693a4fa92f1c1c34e5a714",
      "problem_id": "problem:um-kp-3.54-kirby-problem-3.54-231c55e1",
      "route_id": "route:um-kp-3.54-kirby-problem-3.54-231c55e1-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-3.54-kirby-problem-3.54-231c55e1-source-fidelity-01",
      "graph_id": "graph:um-kp-3.54-kirby-problem-3.54-231c55e1-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-3.54-kirby-problem-3.54-231c55e1-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-3.54-kirby-problem-3.54-231c55e1-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(a) Is there a closed 3-manifold $M$ whose Heegaard Floer homology $\\widehat{HF}(M;\\mathbb{Z})$ has torsion? (b) Is there a rational homology 3-sphere $M$ for which $\\widehat{HF}(M;\\mathbb{Z})$ has torsion? (c) Is there a knot $K\\subset S^3$ whose knot Floer homology $\\widehat{HFK}(S^3,K;\\mathbb{Z})$ has torsion?"
          },
          "statement_sha256": "13944b6c275e7d8daa61b2e2f320b8ad354610c1e49262bf64935cffcaabdefc"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-3.54-kirby-problem-3.54-231c55e1-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-3.54-kirby-problem-3.54-231c55e1-root",
      "route_id": "route:um-kp-3.54-kirby-problem-3.54-231c55e1-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-3.54-348e6ccd0def",
        "url": "https://www.unsolvedmath.com/problems/KP-3.54"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
